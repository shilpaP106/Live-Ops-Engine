...
//TESTING ROUTE
router.get("/shilpa/signup", (req, res) => {
    res.send("signup Route working!!")
})


//NEW USER
router.post("/api/shilpa/signup",
...
router.put("/api/shilpa/user/:emailId",
    async (req, res) => {
...
router.get("/api/shilpa/userlist", async (req, res) => {
    try {
...
//FIND ALL REGISTER USER
router.delete("/api/shilpa/delete/:id", async (req, res) => {
    try {
